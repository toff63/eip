package net.francesbagual.github.eip.pattern.router.contentbased.servlet;
...
@JMSDestinationDefinitions(
		value = {
				@JMSDestinationDefinition(
						name = "jms/queue/contentbasedrouter",
						interfaceName = "javax.jms.Queue",
						destinationName = "contentbasedrouter"
				)
		})
@WebServlet("/router/contentbased")
public class ContentBasedRouterServlet extends HttpServlet {
	...
	@Resource(lookup = "jms/queue/contentbasedrouter")
